...
class ZCRMRecord
{
    ...
    public function create($trigger = null, $lar_id = null, $process = null)
    {
        if (self::getEntityId() != null) {
            $exception = new ZCRMException("Entity ID MUST be null for create operation.",
    ...
    {
        if (self::getEntityId() == null) {
            $exception = new ZCRMException("Entity ID MUST NOT be null for update operation.",
                APIConstants::RESPONSECODE_BAD_REQUEST);
    ...
    {
        if (self::getEntityId() == null) {
            $exception = new ZCRMException("Entity ID MUST NOT be null for delete operation.",
                APIConstants::RESPONSECODE_BAD_REQUEST);
            $exception->setExceptionCode("ID MISSING");
            throw $exception;
        }
    ...
    public function addNote($zcrmNoteIns)
    {
        if ($zcrmNoteIns->getId() != null) {
            $exception =
                new ZCRMException("Note ID MUST be null for creating a note.", APIConstants::RESPONSECODE_BAD_REQUEST);
            $exception->setExceptionCode("ID EXIST");
            throw $exception;
        }
    ...
    {
        if ($zcrmNoteIns->getId() == null) {
            $exception = new ZCRMException("Note ID MUST NOT be null for updating a note.",
                APIConstants::RESPONSECODE_BAD_REQUEST);
            $exception->setExceptionCode("ID MISSING");
            throw $exception;
        }
    ...
    {
        if ($zcrmNoteIns->getId() == null) {
            $exception = new ZCRMException("Note ID MUST NOT be null for deleting a note.",
                APIConstants::RESPONSECODE_BAD_REQUEST);
            $exception->setExceptionCode("ID MISSING");
            throw $exception;
        }
