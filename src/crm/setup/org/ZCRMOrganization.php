...
class ZCRMOrganization
{
    ...
    /**
     * street name of the organization
     *
     * @var string
     */
     ...
     */
    private function __construct(string $orgName, string $orgId)
    {
        $this->orgId = $orgId;
     ...
     * @param  string|null  $orgId  organization record id
     *
     * @return ZCRMOrganization instance of ZCRMOrganization Class
     */
    public static function getInstance(string $orgName = null, string $orgId = null): ZCRMOrganization
    {
     ...
     */
    public function getPrimaryZuid(): string
    {
     ...
     */
    public function setPrimaryZuid(string $primary_zuid): void
    {
     ...
     */
    public function setPrimaryEmail(string $primary_email): void
    {
     ...
     */
    public function setCurrencyLocale(string $currency_locale): void
    {
